...
//}
//
void runTests1D(const unsigned int rounds, const unsigned int lowPow, const unsigned int upperPow, const string &filename){
    ofstream outfile(filename);
    outfile << "Rounds: " << rounds << "\n";
    unsigned int power = lowPow;
    double meanSingleThread = 0;
...
//    runTests(5,32,512,"test_2dArray.txt");
    runTests1D(5,32,512,"test_1dArray.txt");
//    menu(argc,argv);
//    cout<< "arguments"<<endl;
